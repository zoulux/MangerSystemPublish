	...
	<div class="container-fluid">
		<div class="row" id="row1">
			<div class="col-md-4" id="div1">
				<img src="assets/img/logo.png" id="img1" /> <a href="#" id="logo">Student
					Manage System</a>
			</div>
		...
		<div class="row" id="row2">
			...
			<div class="col-md-9">
				<div id="div7">
					...
					<button type="button" class="btn btn-default" data-toggle="modal"
						data-target=".bs-example-modal-sm">修&nbsp;改</button>
						...
						<tbody>
							...
							<tr>
								<td><input type="checkbox" name="checkbox"
									id=<%=user.getSno()%> onclick="updateDeleteRow()">
								</td>
								<td><%=user.getSno()%></td>
								<td><%=user.getSname()%></td>
								<td><%=user.getSports()%></td>
								<td><%=user.getShufen()%></td>
								<td><%=user.getJiexi()%></td>
								<td><%=user.getGaodai()%></td>
								<td><%=user.getSafe()%></td>
								<td><%=user.getEnglish()%></td>
								<td><%=user.getEnglishNet()%></td>
								<td><%=user.getLishi()%></td>
								<td><%=user.getXingshi()%></td>
							</tr>
